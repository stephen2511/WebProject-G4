  ...
  <section class="single-post-content">
      <div class="container">
        <form onsubmit="generate();return false;">
          <!-- <input type="text" id="qr" class="form-control" style="width:30%;" required><br><br> -->
          <div id="qr" style="color: white;">http://192.168.0.125:7882/WebProject-G4/Web_project/index.php</div>
          <input type="submit" class="btn btn-primary" value="Generate QRCode">
        </form>
        <br><br><div id="qrResult" style="height:220px; width:500px"></div>
      </div>
    </section>

  </main><!-- End #main -->
  <!-- ======= Footer ======= -->
  <footer id="footer" class="footer" style="margin-top: 84.5px;">
  ...
  <a href="#" class="scroll-top d-flex align-items-center justify-content-center"><i class="bi bi-arrow-up-short"></i></a>
   ...
   <script type="text/javascript">
    ...
    function generate(){
      ...
      qrcode.makeCode(message.innerText);
    }
  </script>
