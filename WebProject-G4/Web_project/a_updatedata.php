...
<body>
  ...
  <section class="category-section">
                    <div class="container px-4">
                        ...
                        <div class="card-header"><h3 class="text-center font-weight-light my-4">Update Recipe</h3></div>
                                <div class="card border-0 rounded-lg mt-5">
                                    
                                    <div class="card-body">
                                    <form action="a_updateAdmin_function.php" method="POST"  enctype='multipart/form-data'>
                                    <input type="hidden" name="adminId" value="<?php echo $row['id']; ?>">
                                        <div class="form-floating mb-3">
                                            ...
                                            <div class="mt-4 mb-0">
                                            <div class="d-grid">
                                                <button class="btn btn-primary btn-block" name="update" type="submit">Update Recipe</button>
                                            </div>
                                            </div>
                                        </form>
                                    </div>
