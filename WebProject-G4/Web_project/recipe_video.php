    ...
    <div class="container">
      ...
      <div class="col-md-13 post-content" data-aos="fade-up">
        <div class="single-post">
            ...
            <div class="mb-4">
            <h4>Crunchwrap Supreme Recipe Video</h4>
                <div class="video-post">
                  <a href="https://youtu.be/V3PTMGQ5Ce8" class="glightbox link-video">
                    <span class="bi-play-fill"></span>
                    <img src="assets/img/crunchwrapsupreme.jpg" alt="" class="img-fluid">
                  </a>
               </div>
            </div>

            <div class="mb-4">
            <h4>Baked Scallops Recipe Video</h4>
                <div class="video-post">
                  <a href="https://youtu.be/9OnXgkqDg90" class="glightbox link-video">
                    <span class="bi-play-fill"></span>
                    <img src="assets/img/bakedScallops.jpeg" alt="" class="img-fluid">
                  </a>
               </div>
            </div>
